 ...
 */
namespace Smart\Osc\Ui\DataProvider\Product\Form\Modifier;
...
class CustomOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\CustomOptions
{
    ...
    const FIELD_IS_DISPLAY_MODE = 'display_mode';
            ...
            'children' => [
                'record' => [
                    ...
                    'children' => [
                        ...
                        static::FIELD_IS_IMAGE => $this->getIsImageFieldConfig(60),
                        static::FIELD_IS_UPLOAD => $this->getIsUploadFieldConfig(70),
                        static::FIELD_IS_THUMB_COLOR => $this->getIsThumbColorFieldConfig(80),
                        static::FIELD_IS_DISPLAY_MODE => $this->getIsDisplayModeFieldConfig(90),
                        static::FIELD_IS_DEFAULT => $this->getIsDefaultFieldConfig(100),
                        static::FIELD_IS_DELETE => $this->getIsDeleteFieldConfig(110)
                    ]
                ]
            ]
        ];
                ...
                'data' => [
                    'config' => [
                        ...
                        'groupsConfig' => [
                            ...
                            'select' => [
                                'values' => ['drop_down', 'radio', 'checkbox', 'multiple','thumb_g','thumb_gb','thumb_ms'],
                                'indexes' => [
    ...
    protected function getIsImageFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Magento_Catalog/js/components/custom-options-component',
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_IS_IMAGE,
                        'dataType' => Number::NAME,
                        'addbefore' => $this->getCurrencySymbol(),
                        'addbeforePool' => $this->productOptionsPrice->prefixesToOptionArray(),
                        'sortOrder' => $sortOrder,
    ...
    protected function getIsUploadFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Magento_Catalog/js/components/custom-options-component',
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_IS_UPLOAD,
                        'dataType' => Number::NAME,
                        'addbefore' => $this->getCurrencySymbol(),
                        'addbeforePool' => $this->productOptionsPrice->prefixesToOptionArray(),
                        'sortOrder' => $sortOrder,
    ...
    protected function getIsThumbColorFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Magento_Catalog/js/components/custom-options-component',
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_IS_DISPLAY_MODE,
                        'dataType' => Number::NAME,
                        'addbefore' => $this->getCurrencySymbol(),
                        'addbeforePool' => $this->productOptionsPrice->prefixesToOptionArray(),
                        'sortOrder' => $sortOrder,
